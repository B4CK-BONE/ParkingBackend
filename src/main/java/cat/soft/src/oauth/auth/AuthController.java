...
import cat.soft.src.oauth.auth.dto.PostSigninAutoReq;
import cat.soft.src.oauth.auth.dto.PostSigninAutoRes;
import cat.soft.src.oauth.auth.dto.PostSignupReq;
